       ...
       infoWindow = new google.maps.InfoWindow;
          ...
          Array.prototype.forEach.call(zones, function(zoneelement) {
            ...
            var address = zoneelement.getAttribute('address');
              ...
              var minprice = parseInt(zoneelement.getAttribute('min_price'));
              var maxprice = parseInt(zoneelement.getAttribute('max_price'));
              ...
              aTag.className = 'detail';
               ...
               span.textContent = 'Giá từ : '+number_format(minprice,0,",",".")+' - '+number_format(maxprice,0,",",".");
