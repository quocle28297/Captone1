...
<head>
  ...
  <![endif]-->
    ...
    if(isset($_GET['select-Price'])&&!empty($_GET['select-Price'])){
        $query .= " having MIN(room.ROOM_PRICE) ";
        if($_GET['select-Price']==1) $query .= " < 1000000";
        else if($_GET['select-Price']==2) $query .= " < 3000000";
        else if($_GET['select-Price']==3) $query .= " < 5000000";
        else $query .= " > 5000000";
    ...
    <!-- Document Wrapper
        ...
        <!-- Hero Search
                                ...
                                <form class="mb-0">
                                    <div class="form-box search-properties">
                                        <div class="row">
                                            ...
                                            <!-- .col-md-3 end -->
                                            <div class="col-xs-12 col-sm-6 col-md-3">
                                                <input type="submit" value="Tìm Kiếm" name="submit" class="btn btn--primary btn--block">
                                            </div>
                                            <!-- .col-md-3 end -->
            ...
            <?php include('getlatlong.php') ?>
            <script type="text/javascript"> var c = parseInt(<?php echo json_encode($zoom);?>); var a = parseFloat(<?php echo json_encode($latmap);?>); var b = parseFloat(<?php echo json_encode($longmap);?>); </script>
            <script src="js/js.js"></script>
