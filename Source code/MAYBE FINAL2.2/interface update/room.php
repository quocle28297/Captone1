...
<head>
  ...
  <![endif]-->
                ...
                <div class="container">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4">
                        ...
                        <!-- widget request
                            ...
                            <div class="widget widget-request">
                                ...
                                <div class="widget--content">
                                    <form class="mb-0" method="post">
                                        ...
                                        <p class="over_book disable" style="color: red"><strong>NƠI Ở ĐÃ QUÁ SỐ LƯỢNG NGƯỜI ĐẶT!!</br>VUI LÒNG QUAY LẠI SAU!!</strong></p>
                                    </form>
                                </div>
                            ...
                            <div class="report">
                                <div class="widget widget-request baocao">
                                  <h3 style="padding-right: 40px; text-align: center;">Báo cáo</h3>
                        ...
                        <?php
                            if(isset($_POST['baoCao'])&&!empty($_POST['baoCao'])){
                                ...
                                else echo "<script>alert('VUI LÒNG ĐĂNG NHẬP TRƯỚC KHI BÁO CÁO')</script>";
                            }
    ...
    <!-- Footer Scripts
        ...
        ?>
        <?php
                                    $query = "select CONTRACT_ROOM_ID from contract where CONTRACT_ROOM_ID = ".$idroom;
                                    $result = mysqli_query($connection,$query);
                                    if (!$result) {
                                        die('Invalid query: ' . mysqli_error($connection));
                                    }
                                ...
                                ?>
                                    <script type="text/javascript">
                                        $(".form-group").addClass("disable");
                                        $(".thuebtn").addClass("disable");
                                        $(".over_book").removeClass('disable');
                                        $(".over_book").addClass('show');
                                    </script>
                                <?php        
                                    }
                                ?>
