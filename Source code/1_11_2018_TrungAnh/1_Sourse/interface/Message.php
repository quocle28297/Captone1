            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                 ...
                 <form class="mb-0"  method="post" enctype="multipart/form-data">
                    <div class="alert-box success" ><span>success: </span><h4 style="text-align: center;">Tạo phòng thành công.<h4></div>  
                </form>
                <div class="module module-property pull-left">
                    <a href="add-property.php" target="_blank" class="btn"><i class="fa fa-plus"></i style="font-family: Helvetica, Arial">Bấm để tiếp tục</a>
                </div>
