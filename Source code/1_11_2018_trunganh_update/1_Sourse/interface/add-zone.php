                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <form class="mb-0"  method="post" enctype="multipart/form-data"   >
                                <div class="form-box">
                                    <span style="color:black;float:right;text-align:right;"  >ID User:&nbsp <?php echo $_SESSION['ID'];?></span>
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="zone-title" id="zone-title" required="">
                                            </div>
                                        </div>
                     ...
                     <!-- .form-box end -->
                     <input type="submit" id="create-zone" value="save" name="save-zone"  class="btn btn--primary">
                 </form>
             </div>
             <!-- .col-md-12 end -->
         </div>
