...
<body>
                    ...
                    <div class="panel-body">
                        <form method="POST" action="login.php" role="form">
                            <fieldset>
                                ...
                                <a href="index.php" class="btn btn-lg btn-success btn-block" name="btn_submit">Login</a>-->
    ...
    <?php
        ...
        if ($username == "" || $password =="") {
            ...
            $sql = "select * from users where USERS_USERNAME = '$username' and USERS_PASSWORD = '$password' and USERS_ROLE_ID=1";
